...
export function HomePage() {
  ...
  const featuredHeadRef = useScrollReveal()
  const featuredBtnRef  = useScrollReveal()
  const visitRef    = useScrollReveal()
  ...
  return (
    <div className="w-full">
      ...
      <section className="bg-white border-b border-gray-100">
        <div
          ref={perksRef}
          className="reveal-stagger container mx-auto max-w-5xl px-4 py-10 grid grid-cols-1 sm:grid-cols-3 gap-8"
        >
      ...
      <section className="py-20 px-4 container mx-auto max-w-7xl">
        <div ref={featuredHeadRef} className="reveal text-center mb-12">
        ...
        <div ref={featuredBtnRef} className="reveal text-center mt-12">
          <Link to="/menu">
      ...
      <section className="py-20 bg-gray-50 px-4">
        <div className="container mx-auto max-w-5xl">
          ...
          <div ref={visitRef} className="grid grid-cols-1 md:grid-cols-2 gap-6">
